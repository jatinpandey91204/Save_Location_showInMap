...
//    private DatabaseReference mDatabaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_thirdmain);
...
//            Log.d("hey","yo null!!1");
    ...
    public void saveToDB(View V)
    {
        if(TextUtils.isEmpty(mAddressView.getText()) || TextUtils.isEmpty(mInfoView.getText()) || TextUtils.isEmpty(mCategoryView.getText()))
            Toast.makeText(Thirdmain.this,"Please Fill the Address and Info field ",Toast.LENGTH_SHORT).show();
        ...
        else
        {
            ...
            Toast.makeText(Thirdmain.this,"Entered Location was added to DB",Toast.LENGTH_SHORT).show();
        }
    ...
    private void setCurrentLatLong()
    {
        ...
        mLocationListener=new LocationListener()
        {
            ...
            public void onLocationChanged(Location location)
            {
                ...
                Toast.makeText(Thirdmain.this,"Current Location Just Got Updated",Toast.LENGTH_SHORT).show();
            }
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(Thirdmain.this,MainActivity.class);
